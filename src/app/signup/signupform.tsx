export default function SignupForm() {
    return (
        <div className="max-w-[745px] justify-center rounded-md bg-neutral-100 bg-opacity-60 px-11 py-12 shadow-sm backdrop-blur-[27.5px] max-md:px-5">
            <div className="max-md: flex gap-5 max-md:flex-col max-md:items-center max-md:gap-0 ">
                <div className="flex h-auto w-[35%] cursor-pointer flex-col max-md:ml-0 max-md:w-1/2 max-md:rounded-full">
                    <div className="my-auto flex w-full flex-col items-center justify-center self-stretch whitespace-nowrap rounded-full border-2 border-dashed border-stone-600 border-opacity-40 bg-zinc-300 bg-opacity-0 px-20 py-12 text-lg font-medium text-pink-900 shadow-sm max-md:mt-10 max-md:rounded-full max-md:p-5 ">
                        <img
                            loading="lazy"
