...
export default function ProfilePopup() {
    return (
        <ul className="shadow-pop pointer-events-none absolute right-10 top-10  flex max-w-[162px] flex-col items-start rounded-xl bg-primary px-4 py-3.5 text-xl font-medium text-zinc-800">
